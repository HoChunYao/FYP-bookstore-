    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="product-container">
                <div class="cards">
                    <div class="card">
                        <img src="media/free_delivery.png" alt=" " title="" >
                        <h3>Free delivery</h3>
                    ...
                    <div class="card">
                        <img src="media/5percent.png" alt=" " title="" >
                        <h3>Offer 5%</h3>
                        <p class="price">2000 point</p>
                        <a href="book_detailsX.php">
                            <button>Redeem</button>
                        </a>
                    </div>
                    <div class="card">
                        <img src="media/10percent.png" alt=" " title="" >
                        <h3>Offer 10%</h3>
                        <p class="price">2500 point</p>
                        <a href="book_details.php">
                            <button>Redeem</button>
                        </a>
                    </div>
                    <div class="card">
                        <img src="media/deathnote.jpg" alt=" " title="" >
                        <h3>Note Book</h3>
                        <p class="price">5000 point</p>
                        <a href="book_detailsX.php">
                            <button>Redeem</button>
                        </a>
                    </div>
